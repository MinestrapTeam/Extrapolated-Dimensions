package minestrapteam.extracore.item.stack;
...
public class ItemStackTable
{
	...
	{
		return hash(ECStacks.hashCode(item, stackSize, metadata));
	}
	...
	protected static final class Entry
	{
		...
		public boolean equals(Object o)
		{
			...
			{
				return ECStacks.equals(this.value, e.value);
			}
			return false;
		}
		...
		{
			return ECStacks.equals(this.item, this.stackSize, this.metadata, item, stackSize, metadata);
		}
		
		@Override
		public int hashCode()
		{
			return ECStacks.hashCode(this.item, this.stackSize, this.metadata) ^ Objects.hashCode(this.value);
		}
		
		@Override
		public String toString()
		{
			return ECStacks.toString(this.item, this.stackSize, this.metadata) + "=" + this.value;
		}
	}
}
