...
public class ECStacks
{
	...
	{
		return item1 == item2 && (meta1 == meta2 || meta1 == ECCrafting.WILDCARD_VALUE || meta2 == ECCrafting.WILDCARD_VALUE);
	}
	
	public static boolean equals(Item item1, int size1, int meta1, Item item2, int size2, int meta2)
	{
		return item1 == item2 && size1 == size2 && (meta1 == meta2 || meta1 == ECCrafting.WILDCARD_VALUE || meta2 == ECCrafting.WILDCARD_VALUE);
	}
