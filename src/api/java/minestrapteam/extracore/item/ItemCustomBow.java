...
public class ItemCustomBow extends ItemTool
{
	public static final ItemStack DEFAULT_ARROW = new ItemStack(Items.arrow);

	public ItemStack arrow;
	public IIcon[]   iconArray;

	public ItemCustomBow(ToolMaterial toolMaterial)
	{
		this(toolMaterial, DEFAULT_ARROW);
	}

	public ItemCustomBow(ToolMaterial toolMaterial, ItemStack arrow)
	{
