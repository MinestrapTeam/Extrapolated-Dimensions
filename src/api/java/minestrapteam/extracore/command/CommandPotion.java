...
public class CommandPotion extends CommandBase
{
	...
	public void processCommand(ICommandSender sender, String[] args)
	{
		...
		{
			throw new NumberInvalidException("commands.potion.effect.notFound", id);
		}
		...
		if ("give".equals(args[0]))
		{
			...
			if (splash)
			{
				func_152373_a(sender, this, "commands.potion.give.splash.success", potioneffect.getEffectName(), id,
				              duration, amplifier, name);
			}
			else
			{
				func_152373_a(sender, this, "commands.potion.give.success", potioneffect.getEffectName(), id, duration,
				              amplifier, name);
			}
		}
		else if ("add".equals(args[0]))
		{
			...
			func_152373_a(sender, this, "command.potion.remove.success", potioneffect.getEffectName(), id, duration,
			              amplifier, name);
		}
