package minestrapteam.extracore.world.gen;
...
public class OreGen extends WorldGenerator
{
	...
	public boolean generate(World world, Random random, int x, int y, int z)
	{
		if (this.block == null)
		{
			ECLog.error("Cannot generate Ores when the block is set to null!");
			return false;
		}
		if (this.target == null)
		{
			ECLog.error("Cannot generate Ores when the target is set to null!");
			return false;
		}
