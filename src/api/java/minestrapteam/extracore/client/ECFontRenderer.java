...
public class ECFontRenderer extends FontRenderer
{
	private static final ResourceLocation[]	field_111274_c		= new ResourceLocation[256];
	
	public static final ECFontRenderer instance = new ECFontRenderer(Minecraft.getMinecraft().gameSettings, new ResourceLocation("textures/font/ascii.png"), Minecraft.getMinecraft().renderEngine, false);
	static
	{
	...
	public ECFontRenderer(GameSettings gameSettings, ResourceLocation fontTexture, TextureManager textureManager, boolean unicode)
	{
	...
	public static ECFontRenderer getFontRenderer()
	{
		return instance;
	}
