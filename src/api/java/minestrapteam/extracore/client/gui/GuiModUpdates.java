...
public class GuiModUpdates extends GuiScreen implements GuiYesNoCallback
{
	...
	public void drawScreen(int mouseX, int mouseY, float partialTickTime)
	{
		...
		if (update != null)
		{
			...
			this.urlMinY = i;
			for (String s : StringUtils.cutString(update.getUpdateURL(), (this.width - 300) / 5))
			{
			...
			if (!updateNotes.isEmpty())
			{
				...
				{
					this.drawString(this.fontRendererObj, line, 160, i += 10, ECUpdate.getChangeColor(line));
					if (i > this.height - 30)
					{
						break;
					}
	...
	{
		this.updates = ECUpdate.getUpdates(this.showInvalidUpdates);
