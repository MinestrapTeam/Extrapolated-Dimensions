...
public class ECEntities
{
	...
	private static Map<Class, Integer>		CLASS_ID_MAPPING		= ReflectionUtils.getValue(Constants.FIELD_EntityList_classToIDMapping, (Object) null);
	private static Map<String, Integer>		STRING_ID_MAPPING		= ReflectionUtils.getValue(Constants.FIELD_EntityList_stringToIDMapping, (Object) null);
