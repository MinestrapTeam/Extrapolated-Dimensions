...
/**
 * A {@link ArrayList} of {@link IPotionType} that automatically syncs changes made to it with the corresponding {@link
 * NBTTagList} containing the potion types of an {@link ItemStack} stack compound.
 *
 * @author Clashsoft
 */
public class PotionTypeList extends ArrayList<IPotionType>
{
	...
	/**
	 * Loads this {@link PotionTypeList} from the given {@link ItemStack} {@code stack} the syncs the list with it. If
	 * {@code oldEffects} is true and the stack NBT was {@code null}, this method searches for effects that were stored
	 * in the stack's damage value.
	 *
	 * @param stack
	 * 	the stack
	 * @param oldEffects
	...
	public void load(ItemStack stack, boolean oldEffects)
	{
		...
		if (flag1)
		{
			List<PotionEffect> effects = (List<PotionEffect>) ((ItemPotion2) stack.getItem()).getSuperEffects(stack);
