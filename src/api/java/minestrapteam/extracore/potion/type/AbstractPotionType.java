...
import minestrapteam.extracore.potion.recipe.PotionRecipe;
...
public abstract class AbstractPotionType implements IPotionType
{
	...
	public StringBuilder getDisplayName()
	{
		...
		if (amplifier > 0)
		{
			builder.append(" ").append(StringUtils.convertToRoman(amplifier + 1));
		}
		if (duration > 20)
		{
			builder.append(" (").append(duration >= 1000000 ? I18n.getString("potion.infinite") : net.minecraft.util.StringUtils
				                                                                                      .ticksToElapsedTime(duration)).append(")");
		}
