...
public class ReflectionUtils
{
	...
	public static Method getMethod(Class clazz, Object object)
	{
		...
		ECLog.error("Unable to get method specified with " + object);
		return null;
	}
	...
	public static Method getMethod(Class clazz, String[] methodNames, Class[] parameterTypes)
	{
		...
		ECLog
			.error(new NoSuchMethodException("Method not found! (Class: " + clazz + "; Expected field names: " + Arrays.toString(methodNames)));
		return null;
	}
	...
	public static Field getField(Class clazz, String... fieldNames)
	{
		...
		ECLog
			.error(new NoSuchFieldException("Field not found! (Class: " + clazz + "; Expected field names: " + Arrays.toString(fieldNames)));
		return null;
	}
