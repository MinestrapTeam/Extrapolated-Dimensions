...
public class Update
{
	...
	public int validate()
	{
		if (this.compare == NOT_CHECKED)
		{
			...
			{
				String[] split = ECUpdate.splitVersion(this.version);
				String[] newSplit = ECUpdate.splitVersion(this.newVersion);
				String mc = null;
				String newMC = null;
				String version;
				String newVersion;
				...
				this.compare = ECUpdate.compareVersion(version, newVersion);
			}
			else
			{
