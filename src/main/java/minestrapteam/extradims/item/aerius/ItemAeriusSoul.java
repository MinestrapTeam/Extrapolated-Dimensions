...
public class ItemAeriusSoul extends Item
{
	...
	public static final String[] soulNames = new String[] { "blood", "fire", "boss1", "lightning", "grass", "boss2",
		"animals", "forest", "sky", "water", "night", "darkness", "boss3", "myth", "flowers", "light" };
