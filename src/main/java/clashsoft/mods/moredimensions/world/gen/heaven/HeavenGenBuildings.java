...
public class HeavenGenBuildings
{
	...
	public static class HeavenGenBuilding1 extends WorldGenerator
	{
		...
		{
			// Heavencobble frame
			CSWorld.setFrame(world, x, y, z, x + 6, y + 4, z + 6, Heaven.heavenStoneBlocks, 1);
			// Walls
			CSWorld.setCube(world, x, y + 1, z + 1, x, y + 3, z + 5, Heaven.heavenPlanks, 0);
			CSWorld.setCube(world, x + 1, y + 1, z, x + 5, y + 3, z, Heaven.heavenPlanks, 0);
			CSWorld.setCube(world, x + 6, y + 1, z + 1, x + 6, y + 3, z + 5, Heaven.heavenPlanks, 0);
			CSWorld.setCube(world, x + 1, y + 1, z + 6, x + 5, y + 3, z + 6, Heaven.heavenPlanks, 0);
			// Floor
			CSWorld.setCube(world, x + 1, y, z + 1, x + 5, y, z + 5, Heaven.heavenLogs, 0);
			// Door
