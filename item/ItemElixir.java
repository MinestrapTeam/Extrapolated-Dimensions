...
public class ItemElixir extends ItemPotion2
{
	...
	{
		return new CreativeTabs[] { POCItems.AlchemyTab, CreativeTabs.tabAllSearch };
	}
	...
	{
		if (par2CreativeTabs == POCItems.AlchemyTab || par2CreativeTabs == CreativeTabs.tabAllSearch)
		{
