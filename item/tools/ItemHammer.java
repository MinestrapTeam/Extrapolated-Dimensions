...
public class ItemHammer extends ItemTool
{
	...
	{
		super(itemID, 4.5F, material, blocksEffectiveAgainst);
	...
	public float getStrVsBlock(ItemStack stack, Block block)
	{
		...
		return (material == Material.glass || material == Material.piston || material == Material.redstoneLight || material == Material.vine || material == Material.web) ? this.efficiencyOnProperMaterial : super.getStrVsBlock(stack, block);
	}
	
	public static class ItemWarhammer extends ItemHammer
	{
		public ItemWarhammer(int itemID, EnumToolMaterial material)
		{
			super(itemID, material);
			this.damageVsEntity = 5F + material.getDamageVsEntity();
		}
	}
}
