...
public class BlockWillowLog extends BlockLog implements ITubeConnector
{
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("WillowLogSides");
		this.iconLogTop = par1IconRegister.registerIcon("WillowLogTop");
	}
	...
	{
		return getIcon(side, par1World.getBlockMetadata(x, y, z)).equals(iconLogTop);
	}
}