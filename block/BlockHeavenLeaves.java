...
public class BlockHeavenLeaves extends BlockLeavesBase implements IShearable
{
	public static final String[]	LEAF_TYPES		= new String[] { "heavenleaves" };
	public static final String[][]	field_94396_b	= new String[][] { { "heavenleaves_fancy" }, { "heavenleaves" } };
	@SideOnly(Side.CLIENT)
	private int						field_94394_cP;
	private Icon[][]				iconArray		= new Icon[2][];
	private int[]					adjacentTreeBlocks;
	
	public BlockHeavenLeaves(int par1)
	{
