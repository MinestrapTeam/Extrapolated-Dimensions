...
public class BlockMagicOakSapling extends BlockFlower
{
	/** change the name to your sapling name **/
	public static final String[]	WOOD_TYPES	= new String[] { "MagicOak" };
	
	public BlockMagicOakSapling(int i, int j)
	{
		super(i);
		float var3 = 0.4F;
	...
	public void growTree(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		...
		if (!(new WorldGenMagicOakTree(true)).generate(par1World, par5Random, par2 + i1, par3, par4 + j1))
		{
			if (flag)
			{
