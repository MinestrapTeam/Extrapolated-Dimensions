...
public class BiomeDecoratorHeaven extends BiomeDecorator
{
	...
	private WorldGenerator				dirtGen		= new HeavenGenMinable(MDMHeaven.groundBlocks.blockID, 20);
	private WorldGenerator				sywoxiteGen	= new HeavenGenMinable(MDMHeaven.stoneBlocks.blockID, 3, 18);
	private WorldGenerator				clashiumGen	= new HeavenGenMinable(MDMHeaven.stoneBlocks.blockID, 4, 10);
	private WorldGenerator				bluriteGen	= new HeavenGenMinable(MDMHeaven.stoneBlocks.blockID, 5, 8);
	private WorldGenerator				holyiumGen	= new HeavenGenMinable(MDMHeaven.stoneBlocks.blockID, 6, 8);
	private WorldGenerator				treeGen		= new WorldGenTreesMoreDimensions(true, 6, MDMHeaven.heavenLog.blockID, MDMHeaven.heavenLeaves.blockID, 0, 0, false);
