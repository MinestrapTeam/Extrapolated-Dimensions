...
public class HeavenGenTrees extends WorldGenTrees
{
	...
	public HeavenGenTrees(boolean par1)
	{
		this(par1, 4, 0, 0, false);
	}
	
	public HeavenGenTrees(boolean par1, int par2, int par3, int par4, boolean par5)
	{
		super(par1);
				...
				for (int var10 = par3 - var9; var10 <= par3 + var9 && var7; ++var10)
				{
					for (var11 = par5 - var9; var11 <= par5 + var9 && var7; ++var11)
					{
						if (var8 >= 0 && var8 < 256)
						{
							...
							var12_1 = par1World.getBlockMetadata(var10, var8, var11);
