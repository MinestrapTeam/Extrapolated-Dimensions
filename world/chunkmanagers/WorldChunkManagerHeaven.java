...
public class WorldChunkManagerHeaven extends WorldChunkManager
{
	...
	private float			heavenTemperature;
	
	/** The rainfall in the world */
	private float			rainfall;
	
	public WorldChunkManagerHeaven(BiomeGenBase par1BiomeGenBase, float par2, float par3)
	{
		super();
		this.biomeGenerator = par1BiomeGenBase;
		this.heavenTemperature = par2;
		this.rainfall = par3;
	}
	...
	public float[] getTemperatures(float[] par1ArrayOfFloat, int par2, int par3, int par4, int par5)
	{
		...
		Arrays.fill(par1ArrayOfFloat, 0, par4 * par5, this.heavenTemperature);
