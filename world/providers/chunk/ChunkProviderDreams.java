...
public class ChunkProviderDreams implements IChunkProvider
{
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
	{
		...
		if ((!var11) && (this.rand.nextInt(4) == 0))
		{
			...
			new WorldGenLakes(dreamType.getWaterBlock().blockID).generate(this.worldObj, this.rand, var12, var13, var14);
		}
		...
		for (int var12 = 0; var12 < 16; var12++)
		{
			for (int var13 = 0; var13 < 16; var13++)
			{
				...
				{
					this.worldObj.setBlock(var12 + var4, var14 - 1, var13 + var5, dreamType.getIceBlock().blockID);
				}
				if (this.worldObj.canSnowAt(var12 + var4, var14, var13 + var5))
				{
					this.worldObj.setBlock(var12 + var4, var14, var13 + var5, dreamType.getSnowBlock().blockID);
				}
			}
		}
